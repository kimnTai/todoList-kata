...
var requestListener = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var body, _a, title, error_1, id, _b, title, error_2, deleteResult;
    var _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 1:
                _d.sent();
                if (!(req.url === "/todo")) return [3 /*break*/, 11];
                _a = req.method;
                switch (_a) {
            ...
            case 7: return [4 /*yield*/, todo_1.default.deleteMany({})];
            case 8:
                _d.sent();
                (0, handle_1.successHandle)(req, res);
                return [3 /*break*/, 10];
            case 9:
                (0, handle_1.errorHandle)(req, res, "無此方法");
                return [3 /*break*/, 10];
            ...
            case 16: return [4 /*yield*/, todo_1.default.findByIdAndDelete(id)];
            case 17:
                ...
                if (deleteResult) {
                    ...
                    (0, handle_1.errorHandle)(req, res, "無此 id");
                }
                return [3 /*break*/, 19];
            case 18:
                (0, handle_1.errorHandle)(req, res, "無此方法");
...
Promise.resolve().then(function () { return __importStar(require("dotenv/config")); }).then(function () { return __awaiter(void 0, void 0, void 0, function () {
    var _a, PORT, DATABASE, DATABASE_PASSWORD, url;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = process.env, PORT = _a.PORT, DATABASE = _a.DATABASE, DATABASE_PASSWORD = _a.DATABASE_PASSWORD;
                server.listen(PORT);
                console.log("伺服器啟動中");
                url = DATABASE === null || DATABASE === void 0 ? void 0 : DATABASE.replace("<password>", DATABASE_PASSWORD);
